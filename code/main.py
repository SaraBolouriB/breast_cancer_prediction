...
def add_to_dict(ac, kp, ps, rc, fm, mc, ra, pa, table):
...
def main():
    ...
    ac, kp, ps, rc, fm, mc, ra, pa = naive_bayes(dataset=dataset)
    table = add_to_dict(ac, kp, ps, rc, fm, mc, ra, pa, table)

    ### RANDOM FOREST CLASSIFICATION ALGORITHM -------------------------------------------------------
    ac, kp, ps, rc, fm, mc, ra, pa = random_forest(dataset=dataset)
    table = add_to_dict(ac, kp, ps, rc, fm, mc, ra, pa, table)

    ### SVM CLASSIFICATION ALGORITHM -----------------------------------------------------------------
    ac, kp, ps, rc, fm, mc, ra, pa = svm(dataset=dataset)
    table = add_to_dict(ac, kp, ps, rc, fm, mc, ra, pa, table)
    
    ### MLP CLASSIFICATION ALGORITHM -----------------------------------------------------------------
    ac, kp, ps, rc, fm, mc, ra, pa = mlp(dataset=dataset)
    table = add_to_dict(ac, kp, ps, rc, fm, mc, ra, pa, table)
